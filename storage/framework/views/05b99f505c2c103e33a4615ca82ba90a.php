                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="card card-secundary">
                                    <div class="card-body">
                                        <h1 class="text-money"><?php echo e(auth()->user()->affiliate_revenue_share); ?>%</h1>
                                        <p>REVENUE SHARE</p>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/hlspablo/code/cassino/resources/views/panel/affiliates/index.blade.php ENDPATH**/ ?>