<nav class="page__content__navbar">
    <aside class="page__content__navbar__esq">
        ...
        <a href="https://www.instagram.com" target="_blank" class="social-icon" title="Instagram">
            <img src="<?php echo e(asset('assets/images/instagram.png')); ?>" alt="" width="32">
        </a>
        <a href="https://www.tiktok.com/" target="_blank" class="social-icon" title="Tiktok">
            <img src="<?php echo e(asset('assets/images/tiktok.png')); ?>" alt=""  width="32">
        </a>
        <a href="https://whatsapp.com/channel/" target="_blank" class="social-icon" title="Canal Whatsapp">
            <img src="<?php echo e(asset('assets/images/whatsapp.png')); ?>" alt="" width="32">
        </a>
    </aside>
    <aside class="page__content__navbar__dir">

        <?php if(auth()->check()): ?>
            <a class="page__content__navbar__dir__saldo" href="<?php echo e(route('panel.wallet.index')); ?>">
                <h6>Seu saldo </h6>
                <div>
                    <i class="fas fa-plus"></i>
                    <span><?php echo e(\Helper::getBalance()); ?></span>
                </div>
            </a>

            <?php if(auth()->user()->notifications()->count() > 0): ?>
                <a class="page__content__navbar__dir__notificacao" href="<?php echo e(route('panel.notifications.index')); ?>">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <?php if(in_array(auth()->user()->role_id, [0,1])): ?>
                        <li><a class="dropdown-item" href="<?php echo e(url('/admin/login')); ?>"><i class="fa-light fa-screwdriver-wrench menu-dropdown"></i> <span class="m-lg-2">Admin</span></a></li>
                    <?php endif; ?>
                    <li><a class="dropdown-item" href="<?php echo e(route('panel.profile.index')); ?>"><i class="fa-solid fa-user menu-dropdown"></i> <span class="m-lg-2">Meu Perfil</span></a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('panel.wallet.index')); ?>"><i class="fa-regular fa-wallet menu-dropdown"></i> <span class="m-lg-2">Carteira</span></a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('panel.wallet.deposits')); ?>"><i class="fa-solid fa-money-bill-transfer menu-dropdown"></i> <span class="m-lg-2">Depositos</span></a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('panel.wallet.withdrawals')); ?>"><i class="fa-regular fa-money-simple-from-bracket menu-dropdown"></i> <span class="m-lg-2">Saques</span></a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('panel.affiliates.index')); ?>"><i class="fa-regular fa-users-viewfinder menu-dropdown"></i> <span class="m-lg-2">Afiliado</span></a></li>
                    <li><a class="dropdown-item" href="<?php echo e(route('panel.notifications.index')); ?>"><i class="fas fa-bell  menu-dropdown"></i> <span class="m-lg-2">Notificações</span></a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 relative p-0">
                    ...
                    <form id="loginForm" method="post" action="" class="form-login">
                        ...
                        <p>
                            <a href="<?php echo e(route('forgotPassword')); ?>" class="text-white text-small">Esqueci minha senha</a>
                        </p>
                        ...
                        <form id="registrationForm" action="" method="post" class="form-login">
                            ...
                            <?php if(app('request')->input('affiliate')): ?>
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="affiliate_token" readonly class="form-control" placeholder="Token" value="<?php echo e(app('request')->input('affiliate')); ?>" required>
                                </div>
                            <?php endif; ?>
                            <div class="d-grid mt-3">
                                <button type="submit" class="btn-primary-theme btn-block w-full mb-3">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <?php endif; ?>
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/hlspablo/code/cassino/resources/views/includes/navbar_top.blade.php ENDPATH**/ ?>