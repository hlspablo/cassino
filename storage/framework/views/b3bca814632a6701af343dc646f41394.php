            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #fff; border-radius: 10px; box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;">
                <tr>
                    <td style="padding: 20px;">
                        ...
                        <p>Desejamos informar que o usuário <strong><?php echo e($usuario); ?></strong> acabou de solicitar um saque de <strong><?php echo e($valor); ?></strong> em nossa plataforma.</p>
                    </td>
                </tr>
            </table>
        </td>
...
<?php /**PATH /Users/hlspablo/code/cassino/resources/views/emails/new-withdrawal.blade.php ENDPATH**/ ?>