<div class="wallet">
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <a href="<?php echo e(route('panel.wallet.hidebalance')); ?>" class=" float-end">
                ...
                <div class="card-body">
                    <div class="balance">
                        ...
                        <h1 class="show_balance">
                            <?php if(auth()->user()->wallet->hide_balance == 1): ?>
                                ****
                            <?php else: ?>
                                <strong class="text-money"><?php echo e(\Helper::amountFormatDecimal(auth()->user()->wallet->balance)); ?></strong>
                            <?php endif; ?>
                        </h1>
                    </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <h5>
                                <?php if(auth()->user()->wallet->hide_balance == 1): ?>
                                    ****
                                <?php else: ?>
                                    <strong class="text-money"><?php echo e(\Helper::amountFormatDecimal(auth()->user()->wallet->balance_bonus)); ?></strong>
                                <?php endif; ?>
                            </h5>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <h5>
                                <?php if(auth()->user()->wallet->hide_balance == 1): ?>
                                    ****
                                <?php else: ?>
                                    <strong class="text-money"><?php echo e(\Helper::amountFormatDecimal(auth()->user()->wallet->refer_rewards)); ?></strong>
                                <?php endif; ?>
                            </h5>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="d-grid mt-4">
                                <button <?php if(!(auth()->user()->wallet->balance > 0)): ?> disabled="disabled" <?php endif; ?> data-izimodal-open="#withdrawal-modal" data-izimodal-zindex="20000" data-izimodal-preventclose="" class="btn btn-success" type="button">SACAR</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-6">
            <img src="<?php echo e(asset('assets/images/pix.png')); ?>" alt="" class="img-fluid">
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="withdrawalForm" method="post" action="" class="form-login">
                ...
                <h1 class="mb-3 "><?php echo e(\Helper::amountFormatDecimal(auth()->user()->wallet->balance)); ?></h1>

                <h5 class="mb-3 mt-5 font-bold">DIGITE O VALOR PARA SACAR</h5>

                <div class="input-group mb-3">
                    <span class="input-group-text" id="email">
                        <p class="p-4 mb-0">R$</p>
                    </span>
                    <input type="number" name="amount" required min="<?php echo e(config('setting')->min_withdrawal); ?>" max="<?php echo e(config('setting')->max_withdrawal); ?>" class="form-control" placeholder="0,00">
                </div>
                <div class="row">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        document.getElementById('withdrawalForm').addEventListener('submit', function(event) {
            ...
            fetch('<?php echo e(route('panel.wallet.withdrawal')); ?>', {
                method: 'POST',
                body: formData
            })
                    ...
                    if(data.status) {
                        iziToast.show({
                            ...
                            onClosed: function () {
                                ...
                                setTimeout(function() {
                                    window.location.replace('<?php echo e(route('panel.wallet.withdrawals')); ?>');
                                }, 1000);
                            }
                        });
                    }else{
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/hlspablo/code/cassino/resources/views/includes/wallet_card.blade.php ENDPATH**/ ?>